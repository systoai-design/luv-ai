...
export const AuthModal = ({ open, onOpenChange, onSuccess }: AuthModalProps) => {
  ...
  const [resetStep, setResetStep] = useState<'main' | 'reset' | 'sent'>('main');
        ...
        <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
          {resetStep === 'sent' && (
            <div className="space-y-4">
              ...
              <h2 className="text-2xl font-bold text-center">Reset Link Sent</h2>
          ...
          {resetStep === 'main' && (
            <div className="space-y-6">
              <div className="text-center space-y-2">
                ...
                <h2 className="text-3xl font-bold">Welcome to LUVAI</h2>
